...
export const Testimonials = ({ data }: TestimonialsProps) => {
  const defaultTestimonials = [
    ...
    },
    {
      ...
      content: "Já somos clientes há 7 anos e não trocamos de assessoria devido à qualidade no serviço e atendimento tanto do Matheus como de toda a equipe. Alto nível técnico e prático, recomendo!",
    },
    {
      name: "Carlos A A Oliveira",
      role: "Engenheiro Mecânico — Especializado em Projetos de Importação",
      content: "Fui atendido sempre de forma pronta e extremamente profissional nas importações que fizemos. Documentação sempre OK e conhecimento profundo das normas de importação/exportação internacionais. Nota 10, recomendo 100%.",
    },
    {
      name: "Camila Rodrigues",
      role: "Gerente de Compras",
      content: "Ótima assessoria para importar seus produtos dentro da legalidade aduaneira, suporte para Radar e auxílio na classificação fiscal de todos os produtos. Matheus sempre rápido e solícito em todas as nossas dúvidas.",
    },
  ];

  const currentList = data?.testimonials || defaultTestimonials;
    ...
    <section className="py-32 bg-white relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="text-center space-y-6 mb-20 mx-auto">
          ...
          >
            {data?.headerTitle ? (
               data.headerTitle.split(" ").map((word, i) => {
                const isOrange = word.toLowerCase() === "clientes" || word.toLowerCase() === "dizem";
                return (
          ...
          >
            {data?.headerDescription || "Alguns depoimentos de pessoas e empresas que acreditam em nosso trabalho."}
          </motion.p>
        </div>
