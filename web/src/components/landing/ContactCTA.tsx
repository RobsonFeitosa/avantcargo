      ...
      <div className="card-surface p-8 md:p-16 relative overflow-hidden bg-gradient-to-br from-primary/10 via-background to-secondary/10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-end">
            <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground font-bold px-10 h-16 text-lg shadow-glow">
              <MessageSquare className="mr-2 h-5 w-5" /> Fale com um especialista
            </Button>
            <Button size="lg" variant="outline" className="border-border hover:bg-secondary h-16 px-10 font-bold text-lg">
