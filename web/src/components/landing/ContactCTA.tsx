      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-16 items-center">
          ...
          >
            ...
            <Link href="/contato" className="text-slate-400 hover:text-primary transition-colors text-sm flex items-center gap-2 underline underline-offset-4 decoration-slate-200">
