        ...
        <section className="py-24">
          <div className="container">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {areas.map((area, idx) => (
                <Card key={idx} className="p-8 group border-slate-200 bg-white hover:border-primary hover:shadow-xl transition-all duration-300 animate-slide-up shadow-sm">
