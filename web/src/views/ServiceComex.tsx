          ...
          <div className="container relative z-10 text-center">
            <ScrollReveal>
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-10">
                <Button asChild className="bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 md:px-8 h-auto min-h-[56px] py-3 rounded-full shadow-lg shadow-orange-500/20 transition-all hover:scale-105 text-base md:text-lg cursor-pointer whitespace-normal text-center leading-tight">
                ...
                <Button asChild variant="outline" className="border-emerald-900 text-emerald-900 hover:bg-emerald-50 font-bold px-6 md:px-8 h-auto min-h-[56px] py-3 rounded-full transition-all text-base md:text-lg cursor-pointer whitespace-normal text-center leading-tight">
            ...
            <div className="container">
              <div className="p-6 md:p-16 rounded-3xl md:rounded-[48px] bg-gradient-to-br from-primary/5 to-orange-500/5 border border-slate-200 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12 text-center md:text-left">
                ...
                <div className="flex flex-col gap-4 w-full md:w-auto">
                  <Button asChild className="bg-orange-500 hover:bg-orange-600 text-white font-bold h-auto min-h-[56px] py-3 px-6 md:px-10 rounded-full shadow-lg shadow-orange-500/20 text-base md:text-lg gap-2 whitespace-normal text-center leading-tight w-full md:w-auto">
                  ...
                  <Button asChild variant="outline" className="bg-white border-slate-200 text-slate-700 hover:bg-slate-50 h-auto min-h-[56px] py-3 px-6 md:px-10 rounded-full text-base md:text-lg gap-2 whitespace-normal text-center leading-tight w-full md:w-auto">
